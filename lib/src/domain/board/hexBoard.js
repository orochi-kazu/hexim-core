...
export const hexBoard = (polarity, width, height, { wrapping, tileExtrasBuilder = () => ({}) }) => {
  ...
  const neighbourlessBoard = buildBoardWithNeighbourlessTiles(width, height, tileExtrasBuilder)
...
const buildBoardWithNeighbourlessTiles = (width, height, tileExtrasBuilder) =>
